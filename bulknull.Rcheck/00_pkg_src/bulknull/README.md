...
An R package for diagnosing whether an observed bulk-level null result reflects true dilution of a single-cell signal (small cluster fraction + strong effect in cluster) versus a false-positive single-cell call.
...
- **Single-cell cluster shows strong signal** (e.g., zscore > 2)
